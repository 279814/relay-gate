...
**正在做的**是 v1.0.0 的探活重做。需求基线是 [需求与设计](docs/01-需求与设计.md)，任务拆分和做到哪一步以 [P0 实施计划](docs/04-P0-探活基础门禁实施计划.md) 文首为准。P0-01 至 P0-10：生产 L1/L2/ProbeNow 经 ProbeExecutor 发送，结果写入可达性与端点能力。下一步是 P0-11 校准。选路仍主要看原来的路由健康状态。
