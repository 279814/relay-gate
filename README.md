...
**正在做的**是 v1.0.0 的探活重做。需求基线是 [需求与设计](docs/01-需求与设计.md)，任务拆分和做到哪一步以 [P0 实施计划](docs/04-P0-探活基础门禁实施计划.md) 文首为准。P0-01 至 P0-08 已合并，但新的响应分类器还没有接到发送路径；线上探活仍是旧 Prober。下一步是 P0-09。
