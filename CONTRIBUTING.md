...
改 v1.0.0 之前先读两份文档，不要只看 README：`docs/01-需求与设计.md` 是需求基线，`docs/04-P0-探活基础门禁实施计划.md` 文首是当前做到哪一步。README 和 `docs/03-部署与配置.md` 描述的是今天已经能部署的行为。生产探活仍是旧 Prober，新分类器还没接到发送路径。
